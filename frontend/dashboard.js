...
filtered.forEach(e => {
  ...
  row.innerHTML = `
    ...
    <td>
      ${
        isEditing
     ? `<button onclick="cancelEdit()" class="action-btn" style=" background: #fdf6de;   height: 44px; border: none; padding: 6px 12px;  border-radius: 6px;   font-weight: bold;"title="Cancel Edit">❌ Cancel</button>`
